            ...
            <div class="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                ...
                <div class="mx-auto">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('products.index') }}" class="px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 dark:hover:text-white {{ request()->routeIs('products.*') ? 'text-sky-600 dark:text-white' : 'text-slate-400' }}">
                            Stock
                        </a>
                        @can('admin')
                            <a href="{{ route('users.index') }}" class="px-3 py-2 text-sm font-medium rounded-md hover:text-sky-600 dark:hover:text-white {{ request()->routeIs('user.*') ? 'text-sky-600 dark:text-white' : 'text-slate-400' }}">
                              Staff
                            </a>
                        @endcan
