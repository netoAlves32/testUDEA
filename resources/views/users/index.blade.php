...
@section('title', 'Staff')
@section('meta-description','Staff meta-description')
...
<header class="px-6 py-4 space-y-2 text-center">
    <h1 class="font-serif text-3xl text-sky-600 dark:text-sky-500">Staff</h1>
    ...
    @auth
        ...
        href="{{ route('register') }}">Create new user</a>
    @endauth
